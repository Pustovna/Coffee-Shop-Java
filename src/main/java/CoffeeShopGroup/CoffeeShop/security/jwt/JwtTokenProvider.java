package CoffeeShopGroup.CoffeeShop.security.jwt;
...
public class JwtTokenProvider {
    ...
    public String resolveToken(HttpServletRequest req) {
        System.out.println("попытка авторизации" + req.getRequestURL());
//        String bearerToken = req.getHeader("Authorization");

        Cookie cookies = WebUtils.getCookie(req, "token");
        String bearerToken = "";
        if (cookies != null) {
            bearerToken = cookies.getValue();
        }
